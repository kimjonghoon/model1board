...
public class BoardService {
	...
	public BoardService(OracleConnectionManager dbmgr) {
	...
	public List<Article> getBoardList(String keyword, int startRecord, int endRecord) {
		return dao.getBoardList(keyword, startRecord, endRecord);
	}
